...
use neutron_sdk::bindings::query::{NeutronQuery, QueryInterchainAccountAddressResponse, QueryRegisteredQueryResponse};
...
use neutron_sdk::interchain_queries::v045::{new_register_balance_query_msg, new_register_transfers_query_msg};
